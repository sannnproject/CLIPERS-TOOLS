...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AutoClip AI — Turn long videos into short clips, in your browser" },
      {
        name: "description",
        content:
          "AutoClip AI finds the best moments in long videos and exports vertical clips with subtitles and watermarks — fully in your browser.",
      },
      { name: "author", content: "AutoClip AI" },
